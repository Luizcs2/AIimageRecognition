  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="hero text-white p-[250px] text-center h-screen">
        ...
        <button
          className="m-4 bg-blue-500 focus:outline-offset-2 hover:bg-sky-500 text-white p-2 rounded mt-4 hover:scale-105 px-8 "
          onClick={() => navigate("/home")} // Navigate to /home instead of /home.js
        >
          Images
        </button>
        <button
          className="mx-4 bg-blue-500 focus:outline-offset-2 hover:bg-sky-500 text-white p-2 rounded mt-4 hover:scale-105 px-8 "
          onClick={() => navigate("/Videopage")} // Navigate to /videopage instead of /videopage.js
        >
          Video
        </button>
        <motion.div
      ...
      {/* Footer */}
      <footer className="bg-white rounded-lg shadow-sm dark:bg-gray-800 h-[100px] ">
